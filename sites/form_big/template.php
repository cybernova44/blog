...
<head>
    ...
    <script type="text/javascript" src="<?php echo get_res("form_big/res/js/script_1/track-compiled.js"); ?>"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo get_res("form_big/res/css/styles.css"); ?>"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <script type="text/javascript" src="<?php echo get_res("form_big/res/js/script_2/jquery.min.js"); ?>"></script>
    <script type="text/javascript" src="<?php echo get_res("form_big/res/js/script_3/nofile.txt"); ?>"></script>
    <title>Nutislic</title>
    <link type="text/css" rel="stylesheet" href="<?php echo get_res("form_big/res/css/style.css"); ?>">
    <link href="<?php echo get_res("form_big/res/css/componentsStyles.css"); ?>" rel="stylesheet" type="text/css">
    <script src="<?php echo get_res("form_big/res/js/script_4/slick.min.js"); ?>" type="text/javascript"></script>
    <script src="<?php echo get_res("form_big/res/js/script_5/script.js"); ?>" type="text/javascript"></script>
    <script src="<?php echo get_res("form_big/res/js/script_6/script.js"); ?>" type="text/javascript"></script>
    <script src="<?php echo get_res("form_big/res/js/script_7/script.js"); ?>" type="text/javascript"></script>
    <script src="<?php echo get_res("form_big/res/js/script_8/script.js"); ?>" type="text/javascript"></script>
    <script src="<?php echo get_res("form_big/res/js/script_9/core-validator.min.js"); ?>"
            type="text/javascript"></script>
    <script src="<?php echo get_res("form_big/res/js/script_10/script.js"); ?>" type="text/javascript"></script>
    <script src="<?php echo get_res("form_big/res/js/script_11/script.js"); ?>" type="text/javascript"></script>
    <script src="<?php echo get_res("form_big/res/js/script_12/script.js"); ?>" type="text/javascript"></script>
</head>
<body>
                ...
                <div class="container__wrapper--main">
                    ...
                    <div class="x-before_after_one_photo-medical-sp  left">
                        <div class="before_after_one_photo-row">
                            <img
                                        src="<?php echo get_res("form_big/res/img/zdjecie_zona_przed-po_SP_V1_FIN.jpg"); ?>"
                                        class="before_after_one_photo-img">
                        </div>
                        <div class="before_after_one_photo-row">
                            <div class="before_after_one_photo-title before_after_one_photo-title-before"></div>
                            <div class="before_after_one_photo-title before_after_one_photo-title-after"></div>
                        </div>
                        <div class="before_after_one_photo-row">
                            <div class="before_after_one_photo-text"><p><b style="color: red;">VORHER</b></p></div>
                            <div class="before_after_one_photo-text"><p><b style="color: green;">NACHHER</b></p></div>
                        </div>
                    </div>
                    ...
                    <div class="x-profesor_box-medical-sp left"><img style="float:right;   margin-right"
                                                                     class="img right"
                                                                     src="<?php echo get_res("form_big/res/img/zdjecie_profilowe_doktor_SP_V1_FIN.jpg"); ?>"
                                                                     alt="">
                    ...
                    <div class="x-image-medical-sp lazy position-center  left">
                        <img class="image-img"
                                       src="<?php echo get_res("form_big/res/img/zdjecie_chuda_zona_z_dzieckiem_SP_V2_FINa.jpg"); ?>"/>
                    ...
                    <div class="x-image-medical-sp lazy position-left  left">
                        <img class="image-img"
                                       src="<?php echo get_res("form_big/res/img/zdjecie_gruba_zona_z_dzieckiem_SP_V1_FIN.jpg"); ?>"/>
                        <div class="text-container">
                    ...
                    <div class="x-image-medical-sp lazy position-left  left">
                        <img class="image-img"
                                       src="<?php echo get_res("form_big/res/img/zdjecie_rodzina_SP_V1_FIN.jpg"); ?>"/>
                        <div class="text-container">
                    ...
                    <h4 class="x-h4-medical-sp   center" style="font-weight: ; background: yellow; color: #FF0000;">
                    Nach 21 Tagen unter Verwendung der autoketogenen Formel Nixagrim: </h4>
                    <div class="x-infographics-medical-sp  left" style="">
                        <div class="infographics-mobile">
                            <div><img class="product_visualization x1   lazy_image"
                                      src="<?php echo get_res("form_big/res/img/wizualizacja_NIXAGRIM_30capsNUTISLIC-ZEA_small_V1_wieksze.webp"); ?>"
                        ...
                        <div class="infographics-column">
                            <div style="" class="infographics-box auto"><img class="infographics-icon lazy_image"
                                                                             src="<?php echo get_res("form_big/res/img/16kg.png?w=55"); ?>"
                                                                             style="" alt="">
                        ...
                        <div class="infographics-column">
                            ...
                            <div style="" class="infographics-box infographics-box-otherside auto"><img
                                        class="infographics-img lazy_image" style=""
                                        src="<?php echo get_res("form_big/res/img/arrow_180.png?w=150"); ?>"
                                        alt="">
                                <div class="infographics-text" style=""><p>SIE WERDEN DAS RISIKO VON BELÄSTIGENDEN BESCHWERDEN LOS </p></div>
                                <img class="infographics-icon lazy_image"
                                     src="<?php echo get_res("form_big/res/img/dolegliwosci.png?w=55"); ?>"
                                     style="" alt=""></div>
                        </div>
                        <div class="infographics-column">
                            <div style="" class="infographics-box auto"><img class="infographics-icon lazy_image"
                                                                             src="<?php echo get_res("form_big/res/img/ico5.png?w=55"); ?>"
                                                                             style="" alt="">
                                <div class="infographics-text" style=""><p>SIE WERDEN VIEL ENERGIE UND OPTIMISMUS GEWINNEN</p></div>
                                <img class="infographics-img lazy_image" style=""
                                     src="<?php echo get_res("form_big/res/img/arrow_45.png?w=150"); ?>"
                                     alt=""></div>
                            <div style="" class="infographics-box infographics-box-otherside auto"><img
                                        class="infographics-img lazy_image" style=""
                                        src="<?php echo get_res("form_big/res/img/arrow_135.png?w=150"); ?>"
                                        alt="">
                                <div class="infographics-text" style=""><p>SIE WERDEN SICH IN IHREM SCHLANKEN KÖRPER WUNDERBAR FÜHLEN</p>
                                </div>
                                <img class="infographics-icon lazy_image"
                                     src="<?php echo get_res("form_big/res/img/ico31.png?w=55"); ?>"
                                     style="" alt=""></div>
                        </div>
                    </div>
                    ...
                    <div class="x-before_after_one_photo-medical-sp  left">
                        <div class="before_after_one_photo-row">
                            <img
                                        src="<?php echo get_res("form_big/res/img/IMG_wizualizacja_przed-po_SP_V1.jpg"); ?>"
                                        class="before_after_one_photo-img">
                        </div>
                        <div class="before_after_one_photo-row">
                    ...
                    <h4 class="x-h4-medical-sp   center" style="font-weight: 700; background: yellow; color: #FF0000;">
                    BESTÄTIGTE WIRKSAMKEIT </h4>
                    ...
                    <div style="background: " class="x-testimonial-medical-sp border-default">
                        <img class="img"
                                       src="<?php echo get_res("form_big/res/img/KOBIETA_40_lat_15_kg_V1_FIN.jpg"); ?>"
                                       alt="">
                        ...
                        <div class="stars"><img src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>"
                                                class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"></div>
                    ...
                    <div style="text-align: center" class="x-guarantee_2-medical-sp">
                        <div class="box"><img src="<?php echo get_res("form_big/res/img/ico1.png"); ?>"/> <img
                                    src="<?php echo get_res("form_big/res/img/ico2.png"); ?>"/> <img
                                    src="<?php echo get_res("form_big/res/img/ico3.png"); ?>"/></div>
                    </div>
                    <h2 class="x-h2-medical-sp     center" style="color: #8B0000; font-weight: 700;"> Dreifache Zufriedenheitsgarantie </h2>
                    <div class="x-p-medical-sp" style="text-align: left; "><p><b>Echtheitsgarantie </b>– Sie können sicher sein, dass Sie das Originalprodukt erhalten, das nur über diese Website erhältlich ist.</p></div>
                    <div class="x-p-medical-sp" style="text-align: left; "><p><b>Qualitätsgarantie</b>- aufgrund der fortschrittlichen Produktionsmethode erfüllt die autoketogene Formel Nixagrim die höchsten Qualitätsstandards. Alle Inhaltsstoffe der Formel wurden gründlich getestet, was ihre 100% ige Sicherheit für die Gesundheit Ihrer Haut bestätigt.</p></div>
                    <div class="x-p-medical-sp" style="text-align: left; "><p><b>Zufriedenheitsgarantie</b>- Zahlreiche Verbraucher- und wissenschaftliche Tests bestätigen die höchste Wirksamkeit der autoketogenen Formel Nixagrim.</p></div>
...
<div class="x-offer-medical-sp offer ">
	<div class="offer-text1"><p>Erhalten Sie Nixagrim + zusätzliches KOSTENLOSES Geschenk für die Teilnahme am Rabattclub <span style="color: red;"> 139CHF billiger</span></p></div>
	<div class="offer-img_counter">
		<div class="offer-prodbox" style="display: flex; max-width: 300px; ">

												<img class="offer_mobile-img product_visualization x1" src="<?php echo get_res("form_big/res/img/wizualizacja_NIXAGRIM_30capsNUTISLIC-ZEA_small_V1_wieksze.webp"); ?>" alt="">
							
			<img class="offer-g" src="<?php echo get_res("form_big/res/img/de.png"); ?>" alt="" style=" width: 80px; height: auto; top: -5px; right: -5px; display: block">
			
		</div>

					<div class="productCounter">
				<span style="font-weight: bold;font-size: 14px;display: block; margin-bottom: 30px; width: 130px"><p>Verfügbarkeit in aktueller Partie:</p></span>
				<span class="productsCount hundredth">0</span>
				<span class="productsCount decimal">1</span>
				<span class="productsCount units">5</span>
			</div>
			</div>

	<div class="offer-prices">
		<div class="offer-price1"><p>254CHF</p></div>
		<div class="offer-price2"><p>115CHF</p></div>
	</div>
	<div class="offer-text2"><p>Bestellen Sie <u>heute</u> und sparen Sie 139CHF. Nachdem das Limit von 200 Stück erreicht wird, läuft das Sonderangebot ab.</p></div>
</div>
 <script>
 	$(document).on('ready', function () {
                ...
                <div class="container__form" id="form_anh">
                    <div class="x-form_d1m2-medical-sp">
                        <link rel="stylesheet" type="text/css"
                              href="<?php echo get_res("form_big/res/css/CoreFormClassic.css"); ?>">
                        <script src="<?php echo get_res("form_big/res/js/script_13/CoreFormClassic.js"); ?>"></script>
                        <div class="core_form oneStep">
                            <div class="box"><h1 class='headline'>Bestellformular</h1>
                                <div class="icons_safety"><img class="lazy_image"
                                                               src="<?php echo get_res("form_big/res/img/ico1.png"); ?>"/>
                                    <img class="lazy_image"
                                         src="<?php echo get_res("form_big/res/img/ico2.png"); ?>"/>
                                    <img class="lazy_image"
                                         src="<?php echo get_res("form_big/res/img/ico3.png"); ?>"/>
                                </div>
                                <div class="text"><strong>JA!</strong> Ich möchte die Behandlung Nutislic für die Teilnahme am Rabattclub bekommen. Das bedeutet, dass meine Wahl völlig sicher ist, weil das Produkt von einer dreifachen Zufriedenheitsgarantie abgedeckt ist. Das Paket wird mir in den kommenden Tagen ohne zusätzliche Kosten per Post oder Kurier zugestellt.
                                </div>
                                <form method="post" action="" id="testId" novalidate="novalidate">
                                    <div class="error"></div>
                                    <div class="row row_name"><label for="name" class="required">Vorname</label>
                                        <div><input type="text" id="name" name="name" required="required"
                                                    value="<?php echo htmlspecialchars((isset($_POST["name"]) ? $_POST["name"] : $order["name"])); ?>"/>
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="row row_surname"><label for="surname" class="required">Nachname</label>
                                        <div><input type="text" id="surname" name="surname" required="required"
                                                    value="<?php echo htmlspecialchars((isset($_POST["surname"]) ? $_POST["surname"] : $order["surname"])); ?>"/>
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="row row_email"><label for="email" class="required">E-Mail-Adresse</label>
                                        <div><input type="email" id="email" name="email" required="required"
                                                    value="<?php echo htmlspecialchars((isset($_POST["email"]) ? $_POST["email"] : $order["email"])); ?>"/>
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="row row_phone"><label for="phone" class="required">Telefonnummer</label>
                                        <div><input type="text" id="phone" name="phone" required="required"
                                                    value="<?php echo htmlspecialchars((isset($_POST["phone"]) ? $_POST["phone"] : $order["phone"])); ?>"/>
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="row row_address"><label for="address" class="required">Straße, Wohnungsnummer</label>
                                        <div><input type="text" id="address" name="address" required="required"
                                                    value="<?php echo htmlspecialchars((isset($_POST["address"]) ? $_POST["address"] : $order["address"])); ?>"/>
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="row row_city"><label for="city" class="required">Stadt</label>
                                        <div><input type="text" id="city" name="city" required="required"
                                                    value="<?php echo htmlspecialchars((isset($_POST["city"]) ? $_POST["city"] : $order["city"])); ?>"/>
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="row row_pcode"><label for="pcode" class="required">PLZ</label>
                                        <div><input type="text" id="pcode" name="pcode" required="required"
                                                    value="<?php echo htmlspecialchars((isset($_POST["pcode"]) ? $_POST["pcode"] : $order["pcode"])); ?>"/>
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="row row_country"><label for="country">Land</label>
                                        <div>
                                    ...
                                    <div class="row row_note2"><label for="note2">Anmerkungen für den Lieferanten</label>
                                        <div><textarea id="note2" name="note2"></textarea>
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="row row_cod"><label for="cod">Zahlungsform</label>
                                        <div><input type="checkbox" id="cod" name="pay_on_delivery" value="1"/>
                                            <p id="cod_help" class="help-text">Aktivieren Sie dieses Kontrollkästchen, wenn Sie bei Lieferung bezahlen möchten. Wenn Sie dieses Kontrollkästchen nicht aktivieren, werden Sie im nächsten Schritt zur Zahlung aufgefordert.</p></div>
                                    </div>
                                    <div class="row row_save">
                                        <div>
                                            <button type="submit" id="save" name="save">
                                                Klicken Sie hier, um Nutislic zu erhalten
                                            </button>
                                        </div>
                                    </div>
                                    <input type="hidden" id="note" name="note"/><input type="hidden" id="custom"
                                                                                       name="custom"/><input
                                            type="hidden" id="form_type" name="form_type" value="order"/></form>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container__wrapper--sidebar desktop">
                    <div style="background: " class="x-testimonial-medical-sp border-default">
                        ...
                        <div class="stars"><img src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>"
                                    ...
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"></div>
                        <div class="signature"><p>Anna Meyer,</p>
                            <p>35 Jahre, Bern</p></div>
                    </div>
                    <div style="background: " class="x-testimonial-medical-sp border-default">
                        <img class="img" src="<?php echo get_res("form_big/res/img/test_15.jpg"); ?>" alt="">
                        <div class="title" style="color:#FF0000"><p>Schnell und effektiv</p></div>
                        ...
                        <div class="stars"><img src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>"
                                    ...
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"></div>
                        <div class="signature"><p>Lara Graf,</p>
                            <p>73 Jahre, Uster</p></div>
                    </div>
                    <div style="background: " class="x-testimonial-medical-sp border-default">
                        <img class="img" src="<?php echo get_res("form_big/res/img/test_11.jpg"); ?>" alt="">
                        <div class="title" style="color:#FF0000"><p>Die einzige effektive Methode</p></div>
                        <div class="text"><p>Mein Enkel sagte mir einmal - Oma, du siehst aus wie ein Nilpferd. Sie wissen, es ist ein Kind, daher weiß es noch nicht, dass es nicht richtig ist, solche Dinge zu sagen. Aber dann stellte ich fest, dass ich mich um mich selbst kümmern musste. Ich versuchte verschiedene Medikamente zum Abnehmen, aber sie kosteten mich nur viel Geld und halfen nicht. Endlich habe ich diese Formel gefunden. Ich dachte, wenn es sich um einen so guten Arzt handelt, sollte ich es versuchen. <b>Und es hat sich gelohnt! </b>Jetzt fühle ich mich so, als hätte jemand mir meine Jugend wieder gegeben. Alle überschüssigen Kilogramm sind verschwunden. Danke!</p></div>
                        <div class="stars"><img src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>"
                                                class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"></div>
                        <div class="signature"><p>Sofia Steiner,</p>
                            <p>62 Jahre, Emmen</p></div>
                    </div>
                    <div style="background: " class="x-testimonial-medical-sp border-default">
                        <img class="img" src="<?php echo get_res("form_big/res/img/Testimonial_3.png"); ?>"
                                       alt="">
                        <div class="title" style="color:"><p>Sie nennen mich nicht mehr Bär </p></div>
                        <div class="text"><p>Ich war fettleibig und langsam. Ich war sehr verärgert darüber. Vor allem, da meine Ehefrau lamentierte und Angst um meine Gesundheit hatte. Aber ich würde mir nicht umsonst für nichts in der Welt ein Essen oder ein Bier nach der Arbeit versagen. Deshalb werde ich dem Arzt für den Rest meines Lebens dankbar sein, dass er diese Behandlung zur Gewichtsabnahme den Menschen zur Verfügung stellt. Ich habe eine gute Form, ich fühle mich gut und muss mir nichts vorenthalten.</p></div>
                        <div class="stars"><img src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>"
                                                class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"></div>
                        <div class="signature"><p>Nino Widmer,</p>
                            <p>38 Jahre, Dübendorf</p></div>
                    </div>
                    <div style="background: " class="x-testimonial-medical-sp border-default">
                        <img class="img" src="<?php echo get_res("form_big/res/img/test_14.jpg"); ?>"
                                       alt="">
                        <div class="title" style="color:"><p>Dies ist eine Chance für ein neues Leben für mich</p></div>
                        ...
                        <div class="stars"><img src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>"
                                    ...
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"></div>
                        <div class="signature"><p>Giulia Frei,</p>
                            <p>36 Jahre, Neuenburg</p></div>
                    </div>
                    <div style="background: " class="x-testimonial-medical-sp border-default">
                        <img class="img" src="<?php echo get_res("form_big/res/img/Australia.png"); ?>"
                                       alt="">
                        <div class="title" style="color:"><p>Ausgezeichneter körperlicher Zustand ohne Fitnessstudio</p></div>
                        <div class="text"><p>Ich wurde schon immer DICK genannt. Ich war sehr verärgert darüber. Kein Mädchen wollte mit mir verabreden. Im Fitnessstudio haben sie mich nur ausgelacht. Ich war depressiv. Und <b>diese Behandlung hat mich ohne Fitnessstudio schlanker gemacht, und ich esse weiter, was ich will.</b> Einfach perfekt.</p></div>
                        <div class="stars"><img src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>"
                                                class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"></div>
                        <div class="signature"><p>Leonardo Wyss,</p>
                            <p>31 Jahre, Lugano</p></div>
                    </div>
                    <div style="background: " class="x-testimonial-medical-sp border-default">
                        <img class="img"
                                       src="<?php echo get_res("form_big/res/img/foto_komentarz_1_PRZED_PO_V1_FIN.jpg"); ?>"
                                       alt="">
                        <div class="title" style="color:#FF0000"><p>Natürliche Weise zu Übergewicht</p></div>
                        ...
                        <div class="stars"><img src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>"
                                    ...
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"> <img
                                    src="<?php echo get_res("form_big/res/img/star-gold.png"); ?>" class="star"></div>
                        <div class="signature"><p>Alina Brunner,</p>
                            <p>45 Jahre, Zürich</p></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="container__footer">
            ...
            <div class="x-footer_links-medical-sp">
                <link type="text/css" rel="stylesheet" href="<?php echo get_res("form_big/res/css/index2.css"); ?>">
            ...
            <div class="x-footer_text-medical-sp footer_text">
                <link type="text/css" rel="stylesheet" href="<?php echo get_res("form_big/res/css/index.css"); ?>">
                <div class="FooterDisclaimer"><p> Der beschriebene Gegenstand ist ein Nahrungsergänzungsmittel und wird nicht zur Diagnose, Wiederherstellung, Verbesserung oder Veränderung der physiologischen Funktionen des Körpers durch pharmakologische, immunologische oder metabolische Wirkung verwendet. Informationen <a target="_blank"
                                                                                href="?site=disclaimer">Información</a>
                    </p></div>
            </div>
...
<script type="text/javascript" src="<?php echo get_res("form_big/res/js/script_14/bundle.js"); ?>" defer></script>
<script type="application/javascript"
        src="<?php echo get_res("form_big/res/js/script_17/nabx-compiled.js"); ?>"></script>
<script defer type="text/javascript" src="<?php echo get_res("form_big/res/js/script_18/fp.min.js"); ?>"></script>
