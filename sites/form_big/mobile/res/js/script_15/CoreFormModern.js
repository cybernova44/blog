(function($, window, document, undefined) {
    ...
    $.extend(CoreForm.prototype, {
        ...
        bindEvents: function() {
            ...
            if ($('.core_form').hasClass('twoSteps')) {
            ...
            } else if ($('.core_form').hasClass('threeSteps')) {
                ...
                this.steps = [
                    [this.validator.fields.get('email')],
                    [this.validator.fields.get('name'), this.validator.fields.get('surname'), this.validator.fields.get('phone')],
                    [this.validator.fields.get('address'), this.validator.fields.get('number'), this.validator.fields.get('local'), this.validator.fields.get('city'), this.validator.fields.get('pcode'), this.validator.fields.get('country'), this.validator.fields.get('note2'), this.validator.fields.get('lang'), this.validator.fields.get('cod'), this.validator.fields.get('save')]
                ];
            }
            if (this.validate) {
        ...
        stepControl: function(plugin) {
            ...
            if (this.step === 1) {
                ...
                $('.core_form').removeClass('step3');
                $('.core_form').addClass('step2');
            } else if (this.step === 2) {
                $('.core_form').removeClass('step1');
                $('.core_form').removeClass('step2');
                $('.core_form').addClass('step3');
            } else {
                $('.core_form').removeClass('step2');
                $('.core_form').removeClass('step3');
            }
